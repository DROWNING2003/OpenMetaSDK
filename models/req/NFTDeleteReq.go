...
// NFTDeleteReq 销毁NFT
type NFTDeleteReq struct {
	PathParam   nftDeletePathParam   `json:"pathParam"`   //PATH PARAMETERS
	RequestBody nftDeleteRequestBody `json:"requestBody"` //REQUEST BOD
}
